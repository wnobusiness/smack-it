...
//                }
    ...
    func createUser(name: String, email: String, avatarName: String, avatarColor: String, completion: @escaping CompletionHandler) {
        ...
        Alamofire.request(URL_USER_ADD, method: .post, parameters: body, encoding: JSONEncoding.default, headers: BEARER_HEARDER).responseJSON { (response) in
    ...
    func findUserByEmail(completion: @escaping CompletionHandler) {
        ...
        Alamofire.request("\(URL_USER_BY_EMAIL)\(userEmail)", method: .get, parameters: nil, encoding: JSONEncoding.default, headers: BEARER_HEARDER).responseJSON { (response) in
